...
import com.highplace.biz.pm.domain.base.RelationExample.Criteria;
import com.highplace.biz.pm.domain.base.RelationExample.Criterion;
...
public class RelationSqlProvider {
    ...
    public String countByExample(RelationExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("t_relation");
    ...
    public String selectByExampleWithBLOBs(RelationExample example) {
        SQL sql = new SQL();
