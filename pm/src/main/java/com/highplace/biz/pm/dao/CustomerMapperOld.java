...
import com.highplace.biz.pm.domain.CustomerExample;
...
public interface CustomerMapperOld {
    ...
    @Results({
            ...
            @Result(column="customer_id", property="customerPropertyRels", many=@Many(select="com.highplace.biz.pm.dao.CustomerPropertyRelMapper.selectByCustomerId")),
            @Result(column="customer_id", property="customerCars", many=@Many(select="com.highplace.biz.pm.dao.CustomerCarMapper.selectByCustomerId"))
    })
    List<Customer> selectByExampleWithPropertyAndCar(CustomerExample example);
